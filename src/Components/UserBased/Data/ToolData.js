...
const ToolData = [
...

     {
        ...
        groupBy: ['admin','QT_AL','quality', 'quality-s', 'trend_tool','PAT','PAT_Admin','PTS', 'PTS_Admin','QT_PPR','QT_AR']
    },
    // {
    //     id: 0,
    //     name: 'TREND',
    ...
    },
    {
        ...
        link: '/tools/ix_tools',
        groupBy: ['admin', 'IX', 'VI_IX', 'VI_IX_reader', 'soft_at_team', 'IX_SA', 'IX_ER', 'quality', 'IX_reader', 'quality-s','IX_TS','IX_ZTE','IX_T_VI']
    },
    // {
    //     id: 12,
    //     name: 'IX Tracker',
