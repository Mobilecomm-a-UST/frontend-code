...
const UploadReport = () => {
    ...
    const handleSubmit = async () => {
        ...
        if (rawKpiLength > 0) {
            ...
            const response = await makePostRequest('employee_skills/upload-excel/', formData)
            ...
            if (response) {
                ...
                Swal.fire({
                    icon: "error",
                    title: "Oops...",
                    text: `Please refresh the page and select file again`,
                });
            }
        ...
        >
            ...
            <div>
                ...
                <Box style={{ position: 'fixed', right: 20 }}>
                    <Tooltip title="Download Excel Temp.">
