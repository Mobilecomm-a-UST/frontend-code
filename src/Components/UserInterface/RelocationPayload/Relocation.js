                                ...
                                <Sidenav expanded={expanded} defaultOpenKeys={[]} appearance="subtle" style={{ minHeight: "670px", height: "100vh", backgroundColor: "#006e74", marginTop: 8, borderRadius: 10 }}>
                                    <Sidenav.Body>
                                        <Nav activeKey={activeKey} onSelect={setActiveKey} >
                                            ...
                                            <Nav.Item eventKey="2" placement="rightStart" icon={<ChangeListIcon />} className="single-item-custom" onClick={() => { navigate('/tools/relocation_payload_tracker/reference'); show(); setMenuButton(true) }}>
                                                Step 1: Reference File
                                            </Nav.Item>
                                            <Nav.Item eventKey="3" placement="rightStart" icon={<ChangeListIcon />} className="single-item-custom" onClick={() => { navigate('/tools/relocation_payload_tracker/relocation'); show(); setMenuButton(true) }}>
