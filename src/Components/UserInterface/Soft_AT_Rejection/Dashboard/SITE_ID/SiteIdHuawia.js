...
const SiteIdHuawia = (props) => {
    ...
    const downloadExcel = (data) => {
        ...
        // **************** FILEFY DEPENDANCY *****************
        var csvBuilder = new CsvBuilder(`OEM_Huawia_${status}_${site_ID}.csv`)
    ...
    return (
        <div style={{ margin: '2% 4%' }}>
            <MaterialTable
                title={'OEM HUAWEI ' + status+' ' + site_ID}
                columns={columnData}
                data={listData}
