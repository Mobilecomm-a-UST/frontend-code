...
const DateWise = () => {
    ...
    const fetchCircle = async () => {
        ...
        const response = await postData('softat_rej/date_wise_offering_status', formData)
    ...
    const fetchOfferDateWiseOem = async (data) => {
        ...
        const response = await postData('softat_rej/offer_date_wise_oem_wise_circle_wise_summary', formData)
    ...
    const showTableData = async (data) => {
        ...
        const response = await postData('softat_rej/offered_date_wise_oemWise_site_count', formData)
