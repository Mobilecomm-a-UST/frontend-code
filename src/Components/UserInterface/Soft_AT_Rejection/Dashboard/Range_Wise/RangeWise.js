...
const RangeWise = () => {
    ...
    const fetchRangeData = async () => {
        ...
        const responce = await postData('softat_rej/range_wise_rejected_site_count', formData)
    ...
    const rangeWiseData = async (data) => {
        ...
        const responce1 = await postData('softat_rej/range_wise_rejected_remark', formData)
