...
const M_OemHuawia = lazy(() => import('./Dashboard/Master_Dash/OEM/OemHuawia'));
const M_OemNokia = lazy(() => import('./Dashboard/Master_Dash/OEM/OemNokia'));
                                    ...
                                    <Sidenav expanded={expanded} defaultOpenKeys={[]} appearance="subtle">
                                        <Sidenav.Body>
                                            <Nav activeKey={activeKey} onSelect={setActiveKey} style={{ width: 'auto', minHeight: "670px", height: "100hv", backgroundColor: "#223354", marginTop: 8, borderRadius: 10 }}>
                                                ...
                                                {/* <Nav.Item eventKey="2" placement="rightStart" icon={<ViewsUnauthorizeIcon />} onClick={() => { navigate('/tools/soft_at_rejection/rejected_report'); show(); setMenuButton(true) }}>
                                                    Rejected Report
                                                </Nav.Item> */}
                                            </Nav>
                                        </Sidenav.Body>
                    ...
                    <Grid item xs={12} md={10}>
                        ...
                        <Suspense fallback={<div>loading............</div>}>
                            <Routes>
                                ...
                                <Route element={<M_OemHuawia />} path="/master_dashboard/Huawei" />
                                <Route element={<M_OemNokia />} path="/master_dashboard/Nokia" />
...
export default Soft_at_Rejection;