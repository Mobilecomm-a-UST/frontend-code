                            ...
                            <Sidenav expanded={expanded} defaultOpenKeys={[]} appearance="subtle" style={{ minHeight: "670px", height: "100vh", backgroundColor: "#006e74", marginTop: 8, borderRadius: 10 }}>
                                <Sidenav.Body>
                                    <Nav activeKey={activeKey} onSelect={setActiveKey} >
                                        ...
                                        <Nav.Item eventKey="1" placement="rightStart" className="single-item-custom"
                                            icon={<DashboardIcon />} onClick={() => navigate('/tools/cats_tracker/dashboard')} >
                                            Dashboard
                                        </Nav.Item>

                                        <Nav.Item eventKey="2" placement="rightStart" className="single-item-custom"
                                            icon={<FileUploadIcon />} onClick={() => navigate('/tools/cats_tracker/upload_data')} >
                                            Upload Data
                                        </Nav.Item>

                                        <Nav.Item eventKey="3" placement="rightStart" className="single-item-custom"
                                            icon={<PushMessageIcon />} onClick={() => navigate('/tools/cats_tracker/cats_form')} >
                                            CATS Form
                                        </Nav.Item>
