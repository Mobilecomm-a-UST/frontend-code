      ...
      <div>
        ...
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", marginTop: "20px" }}>
          ...
          <Tilt tiltReverse transitionSpeed={1000}>  <div style={{
            ...
            <div style={{ fontFamily: "sans-serif", fontSize: "60px", fontWeight: 500, marginTop: "100px" }}> <span style={{ color: "yellow" }}>CATS Tracker</span> TOOL</div>
          </div></Tilt>
        </div>
      </div>
    </Grow>
...
export default CatsTrackerTool