...
import Ts_Tracker from './TS_Tracker';

const Ts_Trackertool = () => {
  return (
      <>
                                 ...
                                 <Tilt tiltReverse transitionSpeed={1000}>
                                     <div style={{
                                         ...
                                         <div style={{ fontFamily: "sans-serif", fontSize: "60px", fontWeight: 500, marginTop: "100px" }}>
                                             <span style={{ color: "yellow" }}>TS Tracker</span > <span style={{textAlign:'center'}}>Tool</span></div>
                                     </div></Tilt>
                             </div>
                         </div>
