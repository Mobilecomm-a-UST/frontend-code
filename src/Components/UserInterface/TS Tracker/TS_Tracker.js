...
const Ts_Trackertool = lazy(() => import("./Ts_Trackertool"));

const UploadTracker = lazy(()=> import("./Upload Tracker/Uploadtracker"))
const GetTracker = lazy(()=> import("./Upload Tracker/Getracker"))
                ...
                <Grid container spacing={2}>
                                ...
                                <Sidenav expanded={expanded} defaultOpenKeys={[]} appearance="subtle" style={{ minHeight: "670px", height: "100vh", backgroundColor: "#006e74", marginTop: 8, borderRadius: 10 }}>
                                    <Sidenav.Body>
                                        <Nav activeKey={activeKey} onSelect={setActiveKey} >
                                            <Nav style={{ fontWeight: 600, color: 'white', textAlign: 'center', fontSize: 20 }}>TS TRACKER</Nav>
                                            <Divider component="li" sx={{ backgroundColor: 'white' }} />
        

                                              <Nav.Item eventKey="1" placement="rightStart" className="single-item-custom" icon={< FileUploadIcon style={{}} />} onClick={() => { navigate('/tools/ix_tools/ix_tstracker/UploadTracker'); show(); setMenuButton(true) }}>
                                                        Upload Tracker
                                            </Nav.Item> 

                                             <Nav.Item eventKey="2" placement="rightStart" className="single-item-custom" icon={< TableColumnIcon style={{}} />} onClick={() => { navigate('/tools/ix_tools/ix_tstracker/GetTracker'); show(); setMenuButton(true) }}>
                                                        Get Tracker
                                            </Nav.Item> 
                    ...
                    <Grid item xs={12} md={10}>
                        ...
                        <Suspense fallback={<Loader/>}>
                            <Routes>
                               <Route path="/" element={<Ts_Trackertool />} />
                               <Route path="/uploadtracker" element={<UploadTracker />} />
                                 <Route path="/gettracker" element={<GetTracker />} />
