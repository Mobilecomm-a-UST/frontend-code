                                ...
                                <Sidenav expanded={expanded} defaultOpenKeys={[]} appearance="subtle" style={{ minHeight: "670px", height: "100vh", backgroundColor: "#223354", marginTop: 8, borderRadius: 10 }}>
                                    <Sidenav.Body>
                                        <Nav activeKey={activeKey} onSelect={setActiveKey} >
                                            <Nav style={{ fontWeight: 500, color: 'white', textAlign: 'center', fontSize: 20 }}>KPI Matrix TOOL</Nav>
                                            ...
                                            <Nav.Item eventKey="1" placement="rightStart" icon={<TextImageIcon />} onClick={() => { navigate('/tools/kpi_matrix'); show(); setMenuButton(true) }}>
                                                Upload
                                            </Nav.Item>
