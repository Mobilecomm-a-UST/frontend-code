...
export default function ProjectWiseRelocation() {
    const [pwRel,setPwRel]=useState([])
    ...
    const FetchAllRel=async()=>
    {
        const response = await getData('trend/circle_wise_dashboard/?project=Relocation')
        setPwRel(response.data)
