...
export default function ProjectWiseNT() {
    const [pwNT,setPwNT]=useState([])
    ...
    const FetchAllNT=async()=>
    {
        const response = await getData('trend/circle_wise_dashboard/?project=NT')
        setPwNT(response.data)
