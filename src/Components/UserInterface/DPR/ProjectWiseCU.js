...
export default function ProjectWiseCU() {
    const [pwCU,setPwCU]=useState([])
    ...
    const FetchAllCU=async()=>
    {
        const response = await getData('trend/circle_wise_dashboard/?project=capacity upgrade')
        setPwCU(response.data)
