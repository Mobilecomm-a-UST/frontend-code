                            ...
                            <Sidenav expanded={expanded} defaultOpenKeys={[]} appearance="subtle">
                                <Sidenav.Body>
                                    ...
                                    >
                                        ...
                                        {/* {!userTypes?.includes('PN') && <Nav.Item
                                            eventKey="1"
                                            placement="rightStart"
                                            icon={<FileUploadIcon />}
                                            onClick={() => navigate('/tools/performance_new/file_manager')}
                                        >
                                            File Manager
                                        </Nav.Item>}
                                        ...
                                        <Nav.Menu eventKey="2" style={{ fontWeight: 400, color: 'white' }} placement="leftStart" className="menu-title-custom" title="Performance AT" icon={<DashboardIcon />}  >
                                            <Nav.Item
                                                ...
                                                placement="rightStart"
                                                // icon={<DashboardIcon />}
                                                onClick={() => navigate('/tools/performance_new/MasterDashboard')}
                                            >
                                                Performance Aging
                                            </Nav.Item>
                                            <Nav.Item
                                                ...
                                                placement="rightStart"
                                                // icon={<DashboardIcon />}
                                                onClick={() => navigate('/tools/performance_new/performance_at_pending_aging')}
                                            >
                                                Pending Aging
                                            </Nav.Item>
                                            ...
                                            <Nav.Item
                                                ...
                                                placement="rightStart"
                                                // icon={<DashboardIcon />}
                                                onClick={() => navigate('/tools/performance_new/FTR_Aging')}
                                            >
                                                Performance FTR
                                            </Nav.Item>
                                            ...
                                            <Nav.Item
                                                ...
                                                placement="rightStart"
                                                // icon={<AutoGraphIcon />}
                                                onClick={() => navigate('/tools/performance_new/PerformanceFTRGraph')}
                                            >
                                            ...
                                            <Nav.Item
                                                ...
                                                placement="rightStart"
                                                // icon={<DashboardIcon />}
                                                onClick={() => navigate('/tools/performance_new/Performance_Aging_Main_Graph')}
                                            >
                                                Performance Graph
                                            </Nav.Item>
                                        ...
                                        <Nav.Menu eventKey="3" style={{ fontWeight: 400, color: 'white' }} placement="leftStart" className="menu-title-custom" title="SCFT AT" icon={<DashboardIcon />}  >
                                            <Nav.Item
                                                ...
                                                placement="rightStart"
                                                // icon={<DashboardIcon />}
                                                onClick={() => navigate('/tools/performance_new/SCFT_Aging')}
                                            >
                                                SCFT Aging
                                            </Nav.Item>
                                            ...
                                            <Nav.Item
                                                ...
                                                placement="rightStart"
                                                // icon={<DashboardIcon />}
                                                onClick={() => navigate('/tools/performance_new/SCFT_Pending_Aging')}
                                            >
                                                SCFT Pending Aging
                                            </Nav.Item>
                                            ...
                                            <Nav.Item
                                                ...
                                                placement="rightStart"
                                                // icon={<DashboardIcon />}
                                                onClick={() => navigate('/tools/performance_new/SCFT_FTR')}
                                            >
                                                SCFT FTR
                                            </Nav.Item>
                                            ...
                                            <Nav.Item
                                                ...
                                                placement="rightStart"
                                                // icon={<AutoGraphIcon />}
                                                onClick={() => navigate('/tools/performance_new/SCFTFTRGraph')}
                                            >
                                                SCFT FTR Trend
                                            </Nav.Item>
                                            ...
                                            <Nav.Item
                                                ...
                                                placement="rightStart"
                                                // icon={<DashboardIcon />}
                                                onClick={() => navigate('/tools/performance_new/Performance_SR_Wise_Main')}
                                            >
                                                SR Wise Tracking
                                            </Nav.Item>
                                            ...
                                            <Nav.Item
                                                ...
                                                placement="rightStart"
                                                // icon={<DashboardIcon />}
                                                onClick={() => navigate('/tools/performance_new/SCFT_Aging_Main_Graph')}
                                            >
                                                SCFT Aging Graph
                                            </Nav.Item>
                                        ...
                                        <Nav.Menu eventKey="4" style={{ fontWeight: 400, color: 'white' }} placement="leftStart" className="menu-title-custom" title=" Soft AT" icon={<DashboardIcon />}  >
                                            <Nav.Item
                                                ...
                                                placement="rightStart"
                                                // icon={<DashboardIcon />}
                                                onClick={() => navigate('/tools/performance_new/Aging5G')}
                                            >
                                                5G Aging
                                            </Nav.Item>
                                        ...
                                        <Nav.Menu eventKey="5" style={{ fontWeight: 400, color: 'white' }} placement="leftStart" className="menu-title-custom" title=" 5G Performance KPI" icon={<DoingRoundIcon />}  >
                                            <Nav.Item
                                                ...
                                                placement="rightStart"
                                                // icon={<DoingRoundIcon />}
                                                onClick={() => navigate('/tools/performance_new/Performancekpi5g')}
                                            >
                                                5G Performance KPI
                                            </Nav.Item>
                                            ...
                                            <Nav.Item
                                                ...
                                                placement="rightStart"
                                                // icon={<DashboardIcon />}
                                                onClick={() => navigate('/tools/performance_new/Performance_5g_Kpi_dashboard')}
                                            >
                                                Dashboard
                                            </Nav.Item>
                                        </Nav.Menu> */}
