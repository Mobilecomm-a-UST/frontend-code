...
const MonthWise = () => {
    ...
    const fetchDailyData = async () => {
        ...
        const res = await postData("alok_tracker/dismantle_weekly_monthly_dashboard/", formData);
    ...
    const handleExport = async () => {
        ...
        a.href = url;
        a.download = "Yearly_Progress_Dismantle_Waterfall.xlsx";
        a.click();
                ...
                <div style={{ margin: 20 }}>
                    ...
                    <Box style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', alignContent: 'center' }}>
                        <Box style={{ fontSize: 22, fontWeight: 'bold' }}>
                            Yearly Progress - Dismantle Waterfall
                        </Box>
                        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexWrap: 'wrap', gap: 1 }}>
                            ...
                            <Tooltip title="Download Yearly-Dismantle Waterfall">
                                <IconButton
                                    component="a"
