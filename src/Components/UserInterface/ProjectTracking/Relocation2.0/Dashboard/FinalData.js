...
const FinalData = () => {
    ...
    const [editData, setEditData] = useState({
        ...
        five_g_ms2_date: "",
        final_ms2_date: "",
        dismantling_survey_date:"",
        sreq_creq_raised_date:"",
        dismantle_date:"",
        material_pickup_date:"",
        material_submission_date:"",
        oci_done_date:"",
        sign_off_date:"",
        toco_owner_issue:"",
        exit_notice_issue:"",
    ...
    const columnData = [
        ...
        { title: 'Dismantling Survey Date', field: 'dismantling_survey_date' },
        { title: 'SREQ/CREQ Raised Date', field: 'sreq_creq_raised_date' },
        { title: 'Dismantle Date', field: 'dismantle_date' },
        { title: 'Material Pickup Date', field: 'material_pickup_date' },
