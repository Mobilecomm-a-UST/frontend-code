...
//         if (make4GFiles.length > 0 && selectCircle !== '' && siteId.trim() !== '') {
//             action(true)
//             var formData = new FormData();
//             for (let i = 0; i < make4GFiles.length; i++) {
//                 formData.append(`input_files`, make4GFiles[i]);
//             }
//             // formData.append(`files`, make4GFiles);
//             formData.append(`circle`, selectCircle);
//             formData.append(`site_name`, siteId);

//             const response = await postDataa('converter/generate_template/', formData)
...
//                     <Typography color='text.primary'>Converter</Typography>
//                 </Breadcrumbs>
//             </div>
//             <Slide
//                 direction='left'
...
//                                             size="small"
//                                             value={siteId}
//                                             onChange={(event) => { setSiteId(event.target.value); setShowSiteId(false) }}
//                                             sx={{ minWidth: 150 }}
//                                         />
//                                         <div>  <span style={{ display: showSiteId ? 'inherit' : 'none', color: 'red', fontSize: '18px', fontWeight: 600 }}>This Field Is Required !</span> </div>
//                                     </Box>
//                                 </Box>

//                                 <Box className={classes.Front_Box} >
//                                     <div className={classes.Front_Box_Hading}>
//                                         Select Excel/CSV Files:-<span style={{ fontFamily: 'Poppins', color: "gray", marginLeft: 20 }}>{ }</span>
//                                     </div>
...
const circleArray = ['AP', 'CHN', 'KK', 'DEL', 'DEL_Vi','MAG_Vi','MP_Vi','HR', 'RJ', 'JK', 'WB', 'OD', 'MU', 'TN', 'UE', 'BH', 'UPW', 'MP', 'PB', 'KO', 'WB', 'JH', 'AS', 'NE']
                                ...
                                <Box className={classes.Front_Box} >
                                    ...
                                    <div className={classes.Front_Box_Select_Button} >
                                        <div style={{ float: "left" }}>
                                            <Button variant="contained" component="label" color={make4GFiles.length > 0 ? "warning" : "primary"}>
                                                select file
                                                {/* Added .xlsb — the binary Excel workbook format — 
                                                    alongside the existing .xlsx / .xls / .csv types.
                                                    Same single input, no extra UI. */}
