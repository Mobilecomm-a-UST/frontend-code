                    ...
                    >
                        <Box className={classes.main_Box}>
                            ...
                            <Box sx={{ display: download ? 'block' : 'none', textAlign: 'center' }}>
                                <a download href={link}><Button variant="outlined" onClick='' title="Export Excel" startIcon={<FileDownloadIcon style={{ fontSize: 30, color: "green" }} />} sx={{ marginTop: "10px", width: "auto" }}><span style={{ fontFamily: "Poppins", fontSize: "22px", fontWeight: 800, textTransform: "none", textDecorationLine: "none" }}>Download File</span></Button></a>
                            </Box>
