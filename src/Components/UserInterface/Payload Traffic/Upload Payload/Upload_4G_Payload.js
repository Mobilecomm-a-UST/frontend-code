...
const Upload_4G_Payload = () => {
    ...
    const handleSubmit = async () => {
        if (make4GFiles.length > 0) {
            ...
            const response = await postData('payload_traffic/upload4g/', formData)
        ...
        <>
            <div style={{ margin: 5, marginLeft: 10, marginTop: 20 }}>
                <Breadcrumbs aria-label="breadcrumb" itemsBeforeCollapse={2} maxItems={3} separator={<KeyboardArrowRightIcon fontSize="small" />}>
                    ...
                    <Typography color='text.primary'>Upload 4G Payload</Typography>
                </Breadcrumbs>
            </div>
            <Slide
                direction='left'
                            ...
                            <Stack spacing={2} sx={{ marginTop: "-40px" }} direction={'column'}>
                                ...
                                <Box className={classes.Front_Box} >
                                    <div className={classes.Front_Box_Hading}>
                                        Select 4G Upload Files:-<span style={{ fontFamily: 'Poppins', color: "gray", marginLeft: 20 }}>{ }</span>
                                    </div>
...
export default Upload_4G_Payload