...
const OemWiseIntegration = ({ onData }) => {
    ...
    const secondHyperLink = async (props) => {
        ...
        const responce = await makePostRequest('ix_tracker_vi/hyperlink-hyperlink-monthwise-integration-data/', formData)
        if (responce) {
                            ...
                            <tbody>
                                {mainDataT2?.map((item , index) => (
                                    <tr key={index} style={{ textAlign: "center", fontWeigth: 700 }}>
                                        <th>{item.CIRCLE}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: 'DE-GROW' })}>{item['DE-GROW']}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: 'MACRO' })}>{item.MACRO}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: 'RELOCATION' })}>{item.RELOCATION}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: 'RET' })}>{item.RET}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: 'ULS_HPSC' })}>{item.ULS_HPSC}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: 'UPGRADE' })}>{item.UPGRADE}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: 'FEMTO' })}>{item.FEMTO}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: 'HT INCREMENT' })}>{item['HT INCREMENT']}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: 'IBS' })}>{item.IBS}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: 'IDSC' })}>{item.IDSC}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: 'ODSC' })}>{item.ODSC}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: 'RECTIFICATION' })}>{item.RECTIFICATION}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: 'OPERATIONS' })}>{item.OPERATIONS}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: 'OTHERS' })}>{item.OTHERS}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: 'RRU UPGRADE' })}>{item['RRU UPGRADE']}</th> 
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: '5G BW UPGRADE' })}>{item['5G BW UPGRADE']}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: '5G RRU SWAP' })}>{item['5G RRU SWAP']}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: '5G SECTOR ADDITION' })}>{item['5G SECTOR ADDITION']}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: '5G RELOCATION' })}>{item['5G RELOCATION']}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: 'TRAFFIC SHIFTING' })}>{item?.['TRAFFIC SHIFTING']}</th>
                                        <th className={classes.hover} style={{ cursor: 'pointer' }} onClick={() => secondHyperLink({ circle: item.CIRCLE, activity: 'RRU SWAP' })}>{item['RRU SWAP']}</th>
