    ...
    <>
      <Box m={1} ml={2}>
        <Breadcrumbs separator={<KeyboardArrowRightIcon fontSize="small" />}>
          ...
          <Typography color="text.primary">Degrow DPR</Typography>
        </Breadcrumbs>
      </Box>
        ...
        <Box>
          <Box className={classes.main_Box}>
            <Box className={classes.Back_Box} sx={{ width: { md: "75%", xs: "100%" } }}>
              <Box className={classes.Box_Hading}>Make Degrow DPR Summary Data</Box>
              <Stack spacing={2} sx={{ mt: "-40px" }}>
                {/* Mobinate Dump */}
                <UploadSection
                  label="Select DPR Files"
