...
const FTR_Table = () => {
    ...
    const columns = tableData?.length
        ? Object.keys(tableData[0]).filter(key => key !== 'FTR')
        : [];
    ...
    const fetchDailyData = async () => {
        ...
        const res = await postData("alok_tracker/ftr_table/", formData);
                ...
                <div style={{ margin: 20 }}>
                    ...
                    <Box style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', alignContent: 'center' }}>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexWrap: 'wrap', gap: 1 }}>
                            ...
                            <Tooltip title="Download FTR Summary Excel">
                                <IconButton
                                    component="a"
