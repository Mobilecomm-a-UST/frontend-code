                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'center', flexDirection: 'column' }}>
                        ...
                        <Box sx={{ width: '90%', marginLeft: 'auto', marginRight: 'auto' }}>
                            <Grid container rowSpacing={2} columnSpacing={1} direction={{ xs: "column", sm: "column", md: "row" }} style={{}}>
                                {userTypes?.some(role => allowedAirtelRoles.includes(role)) && <Grid item xs={4}>
                                    <Box sx={backgroundStyle} className={classes.des} onClick={handleAirtel}>
                                        <div className={classes.centerIcon}>   <img src="/assets/AIRTEL.webp" alt="Airtel" style={{ width: "70px", height: "70px" }} /></div>
                                        <div >
                                 ...
                                 {userTypes?.some(role => allowedViRoles.includes(role)) && <Grid item xs={4}>
                                    <Box sx={backgroundStyle} className={classes.des} onClick={handleVi}>
                                        <div className={classes.centerIcon}> <img src="/assets/VI.webp" alt="VI" style={{ width: "70px", height: "70px" }} /></div>
                                        <div >
