...
const TentativeCounter = () => {
    ...
    const handleSubmit = async () => {
        ...
        if (rawKpiLength > 0) {
            ...
            formData.append("tantative_counters_file", rawKpiFile.bytes);
            const response = await makePostRequest('RCA_TOOL/tantative_counters_save_data_upload/', formData)
            console.log(' tentative counters lines', response)
            if (response) {
                setOpen(false);
                ...
                <div>
                    <div style={{ margin: 10, marginLeft: 10 }}>
                        <Breadcrumbs aria-label="breadcrumb" itemsBeforeCollapse={2} maxItems={3} separator={<KeyboardArrowRightIcon fontSize="small" />}>
                            ...
                            <Typography color='text.primary'>Tentative Counter 24-Hours</Typography>
                        </Breadcrumbs>
                    </div>
                    ...
                    <Box className={classes.main_Box}>
                        <Box className={classes.Back_Box}>
                            <Box className={classes.Box_Hading}>
                                Upload Tentative Counters 24-Hours
                            </Box>
...
export default TentativeCounter
