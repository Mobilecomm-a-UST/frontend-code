        ...
        <div style={{ margin: 10 }}>
            <div style={{ margin: 5, marginLeft: 10,display:'flex',justifyContent:'space-between',alignItems:'center' }}>
                <Breadcrumbs aria-label="breadcrumb" itemsBeforeCollapse={2} maxItems={3} separator={<KeyboardArrowRightIcon fontSize="small" />}>
                    ...
                    <Typography color='text.primary'>Overall Summary</Typography>
                </Breadcrumbs>
            ...
            <th colspan="8" style={{ fontSize: 24, backgroundColor: "#F1948A", color: "", }}>RANGE WISE</th>
                        ...
                        <thead style={{ position: 'sticky', top: 0, zIndex: 1 }}>
                            <tr style={{ fontSize: 15, backgroundColor: "#223354", color: "white", border: '1px solid white' }}>
                                <th rowSpan='2'  style={{ position: "sticky", left: 0, boxShadow: "5px 2px 5px grey", borderRight: "2px solid black",backgroundColor: "#223354",width:''}}>Circle</th>
