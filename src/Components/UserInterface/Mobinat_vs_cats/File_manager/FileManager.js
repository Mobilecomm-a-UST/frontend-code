...
//     { folder_name: "MO-VS-CAP", api: "mobinate_vs_cats/mo_vs_cap", back_folder: "mo_vs_cap" },
//     { folder_name: "Live In Mobinet", api: "mobinate_vs_cats/live_in_mob", back_folder: "livein_mobinet_data" }
// ];
...
const jsonData = [
    ...
    { folder_name: "RMO File", api: "mobinate_vs_cats/rmo", back_folder: "rmo_data" },
    { folder_name: "MO-VS-CAP", api: "mobinate_vs_cats/mo_vs_cap", back_folder: "mo_vs_cap" },
    // ✅ FIX: this used to point at "mobinate_vs_cats/live_in_mob", which is a
    // POST-only endpoint (used by LiveMobReco.jsx to submit the Reco File and
    // generate a report). File Manager needs the GET-capable listing route
    // instead — the same one LiveMobReco.jsx uses to list existing files —
    // which is "mobinate_vs_cats/mobinet_livein". Using the POST-only route
    // here caused: {detail: "Method \"GET\" not allowed."}
    { folder_name: "Live In Mobinet", api: "mobinate_vs_cats/mobinet_livein", back_folder: "livein_mobinet_data" }
];
const Transition = React.forwardRef(function Transition(props, ref) {
    return (
        <Slide
