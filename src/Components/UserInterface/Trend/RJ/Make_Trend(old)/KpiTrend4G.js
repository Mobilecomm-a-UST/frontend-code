...
const KpiTrend4G = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (rawKpiLength > 0 && siteData.length > 0) {
      ...
      const response = await makePostRequest('trend/raj/makeKpiTrend/4g', formData)
      ...
      <div>
        ...
        <Box className={classes.main_Box}>
          ...
          <Box style={{ display: dlink ? "inherit" : "none" }}>
            <a download href={fileData}><Button variant="outlined" onClick='' startIcon={<FileDownloadIcon style={{ fontSize: 30, color: "green" }} />} sx={{ marginTop: "10px", width: "auto" }}><span style={{ fontFamily: "Poppins", fontSize: "22px", fontWeight: 800, textTransform: "none", textDecorationLine: "none" }}>Download 4G KPI Trend</span></Button></a>
          </Box>
