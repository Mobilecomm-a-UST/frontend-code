...
import { Box, Button, Stack, Breadcrumbs, Link, Typography, FormControl, Select, MenuItem } from "@mui/material";
...
const KpiTrend2G = () => {
    ...
    const [selectCircle, setSelectCircle] = useState('RAJ')
    ...
    const startTour = () => {
        const driverObj = driver({
            ...
            showProgress: true,
            steps: [
                { element: '#step-1', popover: { title: 'Select Circle', description: 'Select circle in this dropdown field', side: "left", align: 'start' } },
                { element: '#step-2', popover: { title: 'Select RAW KPI File', description: 'Select Raw KPI file generated from MyCom Tool', side: "bottom", align: 'start' } },
                { element: '#step-3', popover: { title: 'Pest Site IDs', description: 'Paste site ID in this text field', side: "left", align: 'start' } },
    ...
    const handleSubmit = async () => {
        ...
        if (rawKpiLength > 0 && siteData.length > 0) {
            ...
            const response = await makePostRequest('trend/raj/makeKpiTrend/2g', formData)
            ...
            <div>
                <div style={{ margin: 10, marginLeft: 10 }}>
                    <Breadcrumbs aria-label="breadcrumb" itemsBeforeCollapse={2} maxItems={3} separator={<KeyboardArrowRightIcon fontSize="small" />}>
                        ...
                        <Typography color='text.primary'>Make Trend 2G</Typography>
                    </Breadcrumbs>
                </div>
                ...
                <Box className={classes.main_Box}>
                                ...
                                <Box className={classes.Front_Box_Select_Button} >
                                    <FormControl sx={{ minWidth: 150 }} size="small">
                                        ...
                                        >
                                            ...
                                            <MenuItem value={'NESA'}>NESA</MenuItem>
                    ...
                    <Box style={{ display: dlink ? "inherit" : "none" }}>
                        <a download href={fileData}><Button variant="outlined" onClick='' startIcon={<FileDownloadIcon style={{ fontSize: 30, color: "green" }} />} sx={{ marginTop: "10px", width: "auto" }}><span style={{ fontFamily: "Poppins", fontSize: "22px", fontWeight: 800, textTransform: "none", textDecorationLine: "none" }}>Download 2G KPI Trend</span></Button></a>
                    </Box>
