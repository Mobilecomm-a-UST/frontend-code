    ...
    <div >
      ...
      <Sidenav expanded={expanded} defaultOpenKeys={['1','3']} appearance="subtle">
        <Sidenav.Body>
          ...
          <Nav style={{fontWeight:600,color:'white',textAlign:'center',fontSize:20}}>RJ Trend</Nav>
            ...
            <Nav.Item eventKey="5" icon={<FileUploadIcon/>} onClick={()=>navigate('/trends/rj/make_kpi_trend_old')}>
               Make Trend(old)
            </Nav.Item>
        ...
        <Routes>
          ...
          <Route element={<TrendBox data={'RJ'} />} path="/" />
