...
const startTour = () => {
  ...
  const handleSubmit=async()=>
  {
    ...
    // const response = await postData('trend/kol/makeKpiTrend/old/relocation',formData, {headers: {Authorization: `token ${JSON.parse(localStorage.getItem("tokenKey"))}` }})
    const response = await makePostRequest('trend/kol/makeKpiTrend/old/relocation',formData)
