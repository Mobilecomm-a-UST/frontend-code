...
const Kpi4G = () => {
  ...
  const startTour = () => {
    ...
    const handleSubmit = async () => {
        ...
        if (g2rawKpiLength > 0 && g2siteListLength > 0 && g4rawKpiLength > 0 && g4siteListLength > 0 && mappingFileLength > 0) {
            ...
            const response = await makePostRequest('trend/ktk/makeKpiTrend/old/', formData)
