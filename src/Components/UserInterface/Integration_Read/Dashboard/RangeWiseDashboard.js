...
const RangeWiseDashboard = ({ onData }) => {
    ...
    const columnData = [
        ...
        { title: 'TRX_Count', field: 'TRX_Count' },
        { title: 'PRE_ALARM', field: 'PRE_ALARM' },
        { title: 'GPS_IP_CLK', field: 'GPS_IP_CLK' },
        { title: 'RET', field: 'RET' },
        ...
        { title: 'Mplane_IP', field: 'Mplane_IP' },
        { title: 'SCF_PREPARED_BY', field: 'SCF_PREPARED_BY' },
        { title: 'SITE_INTEGRATE_BY', field: 'SITE_INTEGRATE_BY' },
        { title: 'Site_Status', field: 'Site_Status' },
        {
            title: 'External_Alarm_Confirmation',
            field: 'External_Alarm_Confirmation'
        },
        { title: 'SOFT_AT_STATUS', field: 'SOFT_AT_STATUS' },
        { title: 'LICENCE_Status', field: 'LICENCE_Status' },
        { title: 'ESN_NO', field: 'ESN_NO' },
        {
            title: 'Responsibility_for_alarm_clearance',
            field: 'Responsibility_for_alarm_clearance'
        },
        { title: 'TAC', field: 'TAC' },
        { title: 'PCI_FDD_1800', field: 'PCI_FDD_1800' },
        { title: 'PCI_FDD_2100', field: 'PCI_FDD_2100' },
        { title: 'PCI_L900', field: 'PCI_L900' },
        { title: 'PCI_TDD_10_20', field: 'PCI_TDD_10_20' },
        { title: 'PCI_TDD_20', field: 'PCI_TDD_20' },
        { title: 'RSI_FDD_1800', field: 'RSI_FDD_1800' },
        { title: 'RSI_FDD_2100', field: 'RSI_FDD_2100' },
        { title: 'RSI_L900', field: 'RSI_L900' },
        { title: 'RSI_TDD_10_20', field: 'RSI_TDD_10_20' },
        { title: 'RSI_TDD_20', field: 'RSI_TDD_20' },
        { title: 'GPL', field: 'GPL' },
        { title: 'Pre_Post_Check', field: 'Pre_Post_Check' },
