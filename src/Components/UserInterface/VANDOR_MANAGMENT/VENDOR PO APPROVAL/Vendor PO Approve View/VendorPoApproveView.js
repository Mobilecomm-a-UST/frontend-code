...
import {exportButton} from '@material-table/core'
...
{
  const response = await getData('vendor_management/po_approval/view')
...
const downloadExcel=(data)=>
{
  ...
  // **************** FILEFY DEPENDANCY *****************
  var csvBuilder = new CsvBuilder("vendor_po_approve.csv")
  ...
  return (
    <div style={{margin:'2% 4%'}}>
         <MaterialTable
      title="VENDOR PO APPROVAL REPORT"
      columns={columnData}
      data={viewData}
...
export default VendorPoApproveView