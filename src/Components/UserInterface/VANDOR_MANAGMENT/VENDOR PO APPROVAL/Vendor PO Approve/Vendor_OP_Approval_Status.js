...
const Vendor_OP_Approval_Status = () => {
    const fileData =JSON.parse(sessionStorage.getItem('vendor_op_approval'))
...
export default Vendor_OP_Approval_Status