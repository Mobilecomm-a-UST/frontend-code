                                ...
                                <Sidenav expanded={expanded} defaultOpenKeys={[]} appearance="subtle" style={{ minHeight: "670px", height: "100vh", backgroundColor: "#006e74", marginTop: 8, borderRadius: 10 }}>
                                    <Sidenav.Body>
                                        <Nav activeKey={activeKey} onSelect={setActiveKey} >
                                            ...
                                            <Nav.Item eventKey="1" placement="rightStart" className="single-item-custom" icon={<FileUploadIcon style={{}} />} onClick={() => { navigate('/tools/field_resource_tracking/'); show(); setMenuButton(true) }}>
                                                 Upload File
                                            </Nav.Item>
                                            <Nav.Item eventKey="2" placement="rightStart" className="single-item-custom" icon={<DashboardIcon style={{}} />} onClick={() => { navigate('/tools/field_resource_tracking/'); show(); setMenuButton(true) }}>
                                                 Dashboard
                                            </Nav.Item>
