...
const Comperison = () => {
    ...
    const handleSubmit = async () => {
        if (fddFileLength> 0 && gplFileLength > 0) {
          setOpen(true)
        ...
        <div>
            <div style={{ margin: 10, marginLeft: 10 }}>
                <Breadcrumbs aria-label="breadcrumb" itemsBeforeCollapse={2} maxItems={3} separator={<KeyboardArrowRightIcon fontSize="small" />}>
                    ...
                    <Link underline="hover" onClick={()=>{ navigate('/tools/audit/TDD')}}>TDD</Link>
            ...
            <Box className={classes.main_Box}>
                <Box className={classes.Back_Box} sx={{ width: { md: '75%', xs: '100%' } }}>
                    <Box className={classes.Box_Hading} >
                            Generat Comparison ( TDD )
                    </Box>
                    <Stack spacing={2} sx={{ marginTop: "-40px" }} direction={'column'}>
                        <Box className={classes.Front_Box} >
                            <div className={classes.Front_Box_Hading}>
                                Select FDD Dump File:-<span style={{ fontFamily: 'Poppins', color: "gray", marginLeft: 20 }}>{fdd.filename}</span>
                            </div>
                        ...
                        <Box className={classes.Front_Box} >
                            <div className={classes.Front_Box_Hading}>
                                Select GPL File:-<span style={{ fontFamily: 'Poppins', color: "gray", marginLeft: 20 }}>{gpl.filename}</span>
                            </div>
                            <div className={classes.Front_Box_Select_Button} >
                                <div style={{ float: "left" }}>
