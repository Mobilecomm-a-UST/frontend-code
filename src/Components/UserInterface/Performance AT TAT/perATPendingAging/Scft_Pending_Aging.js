...
const Scft_Pending_Aging = () => {
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            const res = await postData("performance_tat/generate-scft-pending-aging/", formData);
        ...
        <>
            <div style={{ margin: 5, marginLeft: 10, marginTop: 10 }}>
                <Breadcrumbs aria-label="breadcrumb" maxItems={3} separator={<KeyboardArrowRightIcon fontSize="small" />}>
                    ...
                    <Typography color="text.primary">SCFT Pending Aging</Typography>
                </Breadcrumbs>
            </div>
...
export default Scft_Pending_Aging;