...
// // ─────────────────────────────────────────────────────────────────────────────
// // CUSTOM BAR TOP LABEL  ← % removed here
// // ─────────────────────────────────────────────────────────────────────────────
...
//                                 axisLine={false}
//                                 tickLine={false}
//                                 tickFormatter={(v) => v}  // ← % removed from Y-axis
//                                 domain={[0, 100]}
...
//         () => withCircleLine(perfChartRaw, performanceData?.graph_data?.[activeTech], selectedCircle),
//         [perfChartRaw, performanceData, activeTech, selectedCircle]
//     );
//     const offChart = useMemo(
//         () => withCircleLine(offChartRaw, offeredData?.graph_data?.[activeTech], selectedCircle),
//         [offChartRaw, offeredData, activeTech, selectedCircle]
//     );
...
//                     {/* Multi-select category filter + circle filter */}
//                     <CategoryFilterBar
//                         selectedCategories={selectedCategories}
//                         onChange={setSelectedCategories}
