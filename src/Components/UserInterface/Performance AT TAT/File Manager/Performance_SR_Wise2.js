...
//     // ── Effective dates used for display / drill-down state (derived) ──────
//     //    In month mode these are the 26th(prev)->25th(selected) window,
//     //    purely for local display before the API responds. The API itself
//     //    is driven by the `month` param and returns the authoritative range.
