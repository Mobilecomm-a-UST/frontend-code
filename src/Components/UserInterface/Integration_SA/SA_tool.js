         ...
         <div>
           <div style={{ margin: 10, marginLeft: 10 }}>
             <Breadcrumbs aria-label="breadcrumb" itemsBeforeCollapse={2} maxItems={3} separator={<KeyboardArrowRightIcon fontSize="small" />}>
               ...
               <Typography color='text.primary'>5G GPL Slicing</Typography>
           ...
           <div style={{ display: "flex", justifyContent: "center", alignItems: "center", marginTop: "20px" }}>
             ...
             <Tilt tiltReverse transitionSpeed={1000}>  <div style={{textAlign:'center',
               ...
               <div style={{ fontFamily: "sans-serif", fontSize: "60px", fontWeight: 500, marginTop: "100px" }}><span style={{ color: "yellow" }}>5G GPL</span> TOOL</div>
             </div></Tilt>
           </div>
         </div>
       </Grow>
