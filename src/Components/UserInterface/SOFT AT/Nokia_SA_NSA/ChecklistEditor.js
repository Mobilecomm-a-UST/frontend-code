                            ...
                            <Table stickyHeader >
                                <TableHead style={{ fontSize: 18 }}>
                                    <TableRow >
                                        ...
                                        <StyledTableCell align="center">SA <CheckPicker data={perametrer.map(item => ({ label: item, value: item }))} value={selectPerameter} onChange={(value) => { setSelectPerameter(value) }} size="sm" appearance="subtle" placeholder="SA" style={{ width: 40 }} /></StyledTableCell>
                                        <StyledTableCell align="center" >NSA <CheckPicker data={expected.map(item => ({ label: item, value: item }))} value={selectExpected} onChange={(value) => { setSelectExpected(value) }} size="sm" appearance="subtle" placeholder="NSA" style={{ width: 100 }} /> </StyledTableCell>
