...
const Circle_Wise = () => {
  ...
  const { data, refetch } = useQuery({
    ...
    queryFn: async () => {
      ...
      if (response) {
        ...
        setHiperAlarmBucket(response.hyperlink_for_alarm)
        return response;
      }
    },
    staleTime: 400000,
  ...
  const fetchCircle = () => {
    ...
    setHiperAlarmBucket(data.hyperlink_for_alarm)
    // action(true)
        ...
        return (
          <>
            <tr key={index} style={{ textAlign: "center", backgroundColor: '#DC7633', fontSize: 18, fontWeight: 'bold', color: 'white' }}>
              ...
              <td style={{ border: '1px solid black' }}>{item.Airtel}</td>
              ...
              <td style={{ border: '1px solid black' }}>{item.MWTM}</td>
              <td style={{ border: '1px solid black' }}>{item.Total}</td>
            </tr>
          </>
        ...
        return (
          <>
            <tr key={item} className={classes.hover} style={{ textAlign: "center", fontWeigth: 700 }}>
              ...
              <td style={{ fontWeight: 'bold', border: '1px solid black' }}>{item.Airtem}</td>
              ...
              <td style={{ fontWeight: 'bold', border: '1px solid black' }}>{item.MWTM}</td>
              <td style={{ fontWeight: 'bold', border: '1px solid black' }}>{item.Total}</td>
            </tr>
          </>
        ...
        return (
          <>
            <Tr key={item} className={classes.hover} style={{ textAlign: "center", fontWeigth: 700 }}>
              ...
              <Td style={{ border: '1px solid black', color: 'black' }}>{item.Airtel}</Td>
              ...
              <Td style={{ border: '1px solid black', color: 'black' }}>{item.MWTM}</Td>
              <Td style={{ border: '1px solid black', color: 'black' }}>{item.Total}</Td>
            </Tr>
          </>
        ...
        <div style={{ margin: 20 }}>
          ...
          <Box sx={{ display: { xs: 'none', md: 'inherit' } }}>
            <TableContainer sx={{ maxHeight: 500, marginTop: 3, boxShadow: 'rgba(0, 0, 0, 0.24) 0px 3px 8px' }} component={Paper}>
              ...
              <table border="3" style={{ width: "100%", border: "1px solid" }}>
                <tr>
                  <th colspan="7" style={{ fontSize: 24, backgroundColor: "#F4D03F", color: "black", }}>Pending Sites</th>
                </tr>
